...
major_list = ["건설환경공학부",
                "건축공학과","건축토목공학부","건축학과","경영학과","경영학(글로벌)전공","경제학과","고분자시스템공학과","고전학연계전공","공익과법연계전공","공학계열",'교육학과','국어국문학과','국제통상학전공','글로벌경영학과','글로벌경제학과','글로벌리더학부','글로벌융합학부','글로컬문화콘텐츠전공','기계공학부','나노공학과','나노과학공학전공','데이터사이언스융합전공','독어독문학과','디자인학과','러시아어문학과','마이크로시스템기술전공','무용학과','문헌정보학과','물리학과','미디어커뮤니케이션학과','미래인문학연계전공','미술학과','바이오메카트로닉스학과','반도체시스템공학과','법무정책학연계전공','법학과','비교문화전공','사학과','사회복지학과','사회학과','사회환경시스템공학과','생명과학과','생명산업공학전공','소비자학과','소재부품융합공학과','소프트웨어학과','수학과','스포츠과학과','시스템경영공학과','식품생명공학과','신소재공학부','심리학과','아동-청소년학과','앙트레프레너십연계전공','약학과','약학부','여성학전공','연기예술학과','영상학과','영어영문학과','유라시아지역문화경제전공','유전공학과','유학-동양학과','융합생명공학과','융합소프트웨어연계전공','융합소프트웨어연계전공-SCSC','융합소프트웨어연계전공-SW융합','융합소프트웨어전공','융합언어학연계전공','의상학과','의예과','의학과','인공지능융합전공','인포매틱스융합전공','일본학전공','자연과학계열','전자전기컴퓨터공학전공','정보통신계열','정치외교학과','조경학과','중국학전공','차세대바이오헬스 융합트랙','철학과','컬처앤테크놀로지융합전공','컴퓨터공학과','컴퓨터교육과','텍스타일시스템공학과','텍스타일시스템공학전공','통계학과','프랑스어문학과','한국학연계전공','한국학전공','한문교육과','한문학과','행정학과','화학공학-고분자공학부','화학과']
...
conn = engine.connect()
result.df.to_sql(name='major_subject', con=engine, if_exists='replace', index=False)
