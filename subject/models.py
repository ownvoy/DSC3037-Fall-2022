...
class LiberalArts(models.Model):
    ...
    credits_hrs_field = models.CharField(max_length=255,db_column='credits(Hrs)', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
